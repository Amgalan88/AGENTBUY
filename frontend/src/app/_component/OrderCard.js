// src/app/_component/OrderCard.js
"use client";
...
const appLabel = {
    ...
    "1688": "1688 / Alibaba",
    dewu: "Dewu (Poizon)",
    any: "Ямар ч платформ байж болно",
};
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex-1 md:flex md:items-center md:justify-end">
                    <div className="rounded-xl border border-dashed border-slate-300 px-3 py-2 text-[11px] text-slate-600 w-full md:w-auto">
                        Чат (user/agent/admin) — эндээс дэлгэрэнгүй дээр орж мессеж бичнэ.
                    </div>
                </div>
            </div>
