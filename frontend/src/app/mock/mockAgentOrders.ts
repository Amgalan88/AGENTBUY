// src/mock/agentOrders.ts

export interface MockAgentOrder {
  id: string;
  type: "single" | "batch";
  app: string;
  name: string;
...
export interface MockAgentHistoryItem {
  id: string;
  requestId: string;
  app: string;
  name: string;
  status: "offered" | "in-progress" | "success" | "failed";
  updatedAt: string;
}

// Agent-д харагдах идэвхтэй user хүсэлтүүд
export const mockAgentOrders: MockAgentOrder[] = [
  {
    id: "REQ-001",
    type: "single",
    app: "taobao",
...
export const mockAgentHistory: MockAgentHistoryItem[] = [
  {
    id: "HIST-001",
    requestId: "REQ-001",
    app: "taobao",
